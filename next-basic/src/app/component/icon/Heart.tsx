...
const HeartLabel = styled.label`
    ...
    input#toggle-heart:checked + label {
        color: #e2264d;
        filter: none;
    ...
    input#toggle-heart:checked + label:before, input#toggle-heart:checked + label:after {
        -webkit-animation: inherit;
                animation: inherit;
        -webkit-animation-timing-function: ease-out;
                animation-timing-function: ease-out;
        }
    input#toggle-heart:checked + label:before {
        will-change: transform, border-width, border-color;
        -webkit-animation-name: bubble;
                animation-name: bubble;
    }
    input#toggle-heart:checked + label:after {
